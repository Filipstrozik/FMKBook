...
export class FriendService {
  ...
  sendSms(idUser:number, nr: string):Observable<any>{
    ...
    let message = `Zostales polecony przez twojego znajomego. Zaloz konto z tego linku http://localhost:4200/reflink/?pN=${nr}&id=${this.userId.getNumber()} i zgarnijcie rabaty`
